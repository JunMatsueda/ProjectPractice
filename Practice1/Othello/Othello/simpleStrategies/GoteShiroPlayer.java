...
/*
		...
		for(int i=0;i<SIZE;i++){
			for(int j=0;j<SIZE;j++){
				if(check_state[i][j]==4){
					...
					if((next_state[0][0]!=3&&next_state[0][7]!=3)&&(next_state[7][0]!=3&&next_state[7][7]!=3)){
						m.x=i;
						m.y=j;
					}
				}
	...
	private Move openningStrategy(GameState currentState){
		...
		move.x = yoko;
		move.y = tate;
		System.out.println("openningStrategy");
		return move;
	}
...
/*
		...
		*/if(check_state[2][2]==4){ //中四隅
			...
			yoko=5;
			tate=7;
		}else if(check_state[0][1]==4 && (check_state[0][0]==2 || (check_state[0][0]==1 && check_state[0][2]==1))){
			yoko=0;
			tate=1;
		}else if(check_state[1][0]==4 && (check_state[0][0]==2 || (check_state[0][0]==1 &&check_state[2][0]==1))){
			yoko=1;
			tate=0;
		}else if(check_state[6][0]==4 && (check_state[7][0]==2|| (check_state[7][0]==1 && check_state[5][0]==1))){
			yoko=6;
			tate=0;
		}else if(check_state[7][1]==4 && (check_state[7][0]==2 || (check_state[7][0]==1 && check_state[7][2]==1))){
			yoko=7;
			tate=1;
		}else if(check_state[0][6]==4 && (check_state[0][7]==2|| (check_state[0][7]==1 && check_state[0][5]==1))){
			yoko=0;
			tate=6;
		}else if(check_state[1][7]==4 && (check_state[0][7]==2 || (check_state[0][7]==1 && check_state[2][7]==1))){
			yoko=1;
			tate=7;
		}else if(check_state[6][7]==4 && (check_state[7][7]==2|| (check_state[7][7]==1 && check_state[6][7]==1))){
			yoko=6;
			tate=7;
		}else if(check_state[7][6]==4 && (check_state[7][7]==2 || (check_state[7][7]==1 && check_state[7][5]==1))){
			yoko=7;
			tate=6;
		}else */{
			if(count>15){
